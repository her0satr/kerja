...
define('SKP_KREATIVITAS',						'skp_kreativitas');
define('SKP_PEJABAT',							'skp_pejabat');
define('SKP_PERILAKU_KERJA',					'skp_perilaku_kerja');
define('SKP_REALISASI',							'skp_realisasi');
define('SKP_SASARAN_KERJA',						'skp_sasaran_kerja');
define('SKP_SUMMARY',							'skp_summary');
define('SKP_TUGAS_TAMBAHAN',					'skp_tugas_tambahan');
define('SKPD',									'skpd');
