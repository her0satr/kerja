<?php
	...
	$page_data = array();
?>
<?php $this->load->view( 'common/meta', array( 'title' => 'Rekap Posisi Tahunan' ) ); ?>
...
<div class="content enlarged">
	...
	<div class="hide cnt-data"><?php echo json_encode($page_data); ?></div>
  	...
  	<div class="mainbar">
	    <div class="page-head">
			<h2 class="pull-left button-back">Rekap Posisi Tahunan</h2>
...
$(document).ready(function() {
	var page = {
		...
		render_chart: function() {
			...
			// get data
			Func.ajax({ url: web.host + 'surat/surat_masuk/rekap_posisi_tahunan/action', param: Func.form.get_value('form-search'), callback: function(result) {
				Morris.Line({
					parseTime: false,
					element: 'cnt-chart',
					data: result,
