<?php $this->load->view( 'common/meta', array( 'title' => 'Status Perkawianan' ) ); ?>
...
<div class="content">
	<?php $this->load->view( 'common/sidebar'); ?>
  	...
  	<div class="mainbar">
	    <div class="page-head">
			<h2 class="pull-left button-back">Status Perkawianan</h2>
	    ...
	    <div class="matter"><div class="container">
            <div class="row"><div class="col-md-12">
				...
				<div class="widget hide" id="form-status">
					<div class="widget-head">
						<div class="pull-left">Form Status Perkawianan</div>
						<div class="widget-icons pull-right">
							<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
							<a href="#" class="wclose"><i class="fa fa-times"></i></a>
						</div>
...
$(document).ready(function() {
	...
	var param = {
		id: 'datatable',
		source: web.host + 'master/status_perkawinan/grid',
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.host + 'master/status_perkawinan/action', param: { action: 'get_by_id', id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.form.del({
					...
					url: web.host + 'master/status_perkawinan/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
	...
	$('#form-status form').submit(function(e) {
		...
		Func.form.submit({
			url: web.host + 'master/status_perkawinan/action',
