<?php $this->load->view( 'common/meta', array( 'title' => 'Sifat Surat' ) ); ?>
...
<div class="content enlarged">
	<?php $this->load->view( 'common/sidebar'); ?>
  	...
  	<div class="mainbar">
	    <div class="page-head">
			<h2 class="pull-left button-back">Sifat Surat</h2>
	    ...
	    <div class="matter"><div class="container">
            <div class="row"><div class="col-md-12">
				...
				<div class="widget hide" id="form-sifat">
					<div class="widget-head">
						<div class="pull-left">Form Sifat Surat</div>
						<div class="widget-icons pull-right">
							<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
							<a href="#" class="wclose"><i class="fa fa-times"></i></a>
						</div>
...
$(document).ready(function() {
	...
	var param = {
		id: 'datatable',
		source: web.host + 'master/sifat_surat/grid',
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.host + 'master/sifat_surat/action', param: { action: 'get_by_id', id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.form.del({
					...
					url: web.host + 'master/sifat_surat/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
	...
	$('#form-sifat form').submit(function(e) {
		...
		Func.form.submit({
			url: web.host + 'master/sifat_surat/action',
