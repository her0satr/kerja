...
<div style="font-size: 16px; font-weight: bold; padding: 0 0 20px 0;">
	<div>BUKU PENJAGAAN KENAIKAN PANGKAT  DAN REALISASINYA</div>
...
<table style="width: 100%; border-collapse: collapse; vertical-align: middle;">
	<tr class="center">
		...
		<td class="border" rowspan="2" style="width: 50px;">PENDI DIKAN</td>
		...
		<td class="border" colspan="4" style="width: 150px;">REALISASI PENERBIT SK</td>
	...
	<tr class="center">
		...
		<td class="border" style="width: 50px;">TMT</td>
		<td class="border" style="width: 50px;">GAJI POKOK</td>
		<td class="border" style="width: 50px;">PEJABAT YG BERWENANG</td>
	</tr>
	<tr class="center">
