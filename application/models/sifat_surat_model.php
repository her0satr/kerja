...
class sifat_surat_model extends CI_Model {
    ...
    function update($param) {
        ...
        if (empty($param['id'])) {
            $insert_query  = GenerateInsertQuery($this->field, $param, SIFAT_SURAT);
            ...
            $update_query  = GenerateUpdateQuery($this->field, $param, SIFAT_SURAT);
    ...
    function get_by_id($param) {
        ...
        if (isset($param['id'])) {
            $select_query  = "
				SELECT sifat_surat.*
				FROM ".SIFAT_SURAT." sifat_surat
				WHERE sifat_surat.id = '".$param['id']."'
				LIMIT 1
			";
		}
    ...
    function get_array($param = array()) {
		...
		$select_query = "
			SELECT SQL_CALC_FOUND_ROWS sifat_surat.*
			FROM ".SIFAT_SURAT." sifat_surat
