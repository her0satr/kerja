...
class Event_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array( 'id', 'name', 'content', 'thumbnail' );
    }
    ...
    function get_array($param = array()) {
		...
		$param['field_replace']['rupiah_angka_format'] = 'Event.rupiah_angka';
		
		$string_penjualan = (!empty($param['penjualan_id'])) ? "AND Event.penjualan_id = '".$param['penjualan_id']."'" : "";
